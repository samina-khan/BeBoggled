...
public class BBWords implements GlobalConstants {
    ...
    public String Grid(int level){
        ...
        // This hashmap is just used to get a count of the words in the grid
    ...
    */
    public int wordsValue(String candidateWord) {
        ...
        word_len = validWords.getOrDefault(candidateWord,0);
        return word_len;        
    }
    ...
    private int LoadWordsFile() {
        ...
        try {
            ...
            System.err.println("Exception occurred while trying to open the valid words file !!!\n");
            e.printStackTrace();
    ...
    private void set_grid(String grid_str) {
        for (int i = 0; i < current_grid_size; i++) {
            for (int j = 0; j < current_grid_size; j++) {
                grid[i][j] = grid_str.charAt(i*4 +j);
            }
        }     
    }
    ...
    private void set_annotated_grid(String grid_str) {
        for (int i = 0; i < current_grid_size; i++) {
            for (int j = 0; j < current_grid_size; j++) {
                annotated_grid[i][j] = grid_str.charAt(i*4 +j);
            }
        }
    }   
    ...
    public static void main(String[] args) {
        ...
        BBWords BBWords1 = new BBWords();
        
        
        // TO_DO this is running in debug mode
        System.out.println(BBWords1.Grid(BBNormalLevel));
       
        /*
        BBWords1.annotatedGrid("byjmqajmlontrnng", "banjo");       
        BBWords1.dumpGrid(); 
        BBWords1.dumpAnnotatedGrid();
        BBWords1.dumpGridWords();
        
        BBWords1.annotatedGrid("byjmqajmlontrnng", "lang"); 
        BBWords1.dumpGrid(); 
        BBWords1.dumpAnnotatedGrid();
        BBWords1.dumpGridWords();
        */
        ...
        BBWords1.dumpAllAnnotatedGrids();
        
        System.out.println("dtawwammx02co1xj");        
        System.out.println(BBWords1.wordPosFromAnnotatedGrid("dtawwammx02co1xj"));
         
        System.out.println(BBWords1.getGridWords());
        System.out.println("Thanks for playing BeBoggled!");
    }    
}
